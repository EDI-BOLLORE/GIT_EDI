...
public class Element implements Cloneable {
	...
	// segments
	// Il peut s'agir d'un élément simple si components est vide ou un group si
	// des composants
	// Exemple d'élément simple dans le CUSCAR 95B: 3035 PARTY QUALIFIER dans le
	// segment NAD
